<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="Gigimu.Login" %>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox ID="txtEmail" placeholder="Enter Email..." CssClass="form-control form-control-user" runat="server" />
                                        </div>
                                        <div class="form-group">
